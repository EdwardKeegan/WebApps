...
var content = `
    ...
    `;
        ...
        objContainer.appendChild(MakeObj("Nevada", "pics/balloons.png", "$695 for 3 days/nights"));
        objContainer.appendChild(MakeObj("Japan", "pics/japan.png", "$2400 for 6 days/nights"));
        objContainer.appendChild(MakeObj("Sydney", "pics/sydney.png", "$5900 for 9 days/nights"));
