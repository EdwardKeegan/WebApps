...
function blogContent() {
    ...
    var content = ` 
        ...
        <h4>Hw05 WebApi</h4>
        <p>
            I have enjoyed the labs centered around database design. The SQL statements make sense to me,
            I do not have any prior expereince with server side database access code. The instructions 
            were clear and easy to follow for this homework, adding the connection to MYsql and adding in our database was straightforward.
            Having the Web_Users example to go off of made it less frustrating to get the "other" jsp file working well.
            I did have to change beds, baths, lotsizeacres in my MYSQL table because they were set up as decimals but the only formating
            for decimals availabe was as a currency, so I went back and changed them to just standard integers. Something that was hard was I added an extra FormatUtil, <br>
            to accompany one of my table columns.
            
            Click <a target="_blank" href="docs/WebAPI_db_errors.pdf">here</a> to see my Web aPI error document
        </p>
        <p>
            Click 
             <a href="webAPIs/listUsersAPI.jsp" target="_blank">here</a>
             to see the ListUsersAPI pull data from the web_user and user_role tables of MY database.<br>
            Click 
             <a href="webAPIs/listOtherAPI.jsp" target="_blank">here</a>
             to see the ListOtherAPI pull data from my "OTHER" table in MY database. 
