...
function userListContent() {
    ...
    function processUserList(userList) {
        ...
        var displayTemplate = "<img src='${obj.image}'/> <span>${obj.userEmail}, " +
                " born on ${obj.birthday}. Membership Fee is ${obj.membershipFee} </span>";

        userListDiv.appendChild(MakeInsertList(userList, userInputSpecs, displayTemplate));

        // to show that the consumer's userList is updated (with objects inserted by the user):
