function FindAlt() {
   ...
   // BirthdayInput.setAttribute("type", "password"); // so it shows dots not characters
    ...
    findButton.onclick = function () {
        ...
        var url = "webAPIs/getUserAlt.jsp?minMembershipFee=" + encodeURI(MembershipInput.value) + "&maxBirthday="
                    + encodeURI(BirthdayInput.value);
