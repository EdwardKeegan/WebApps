function MakeImgAndZoom(picFileName, width, height) {
    ...
    // just moved this function to be first private method within MakeImgAndZoom
    // This method will only be called when the user moves the mouse (after the 
    // component has been added to the page and image sizes are known). 
    // This method references result, lens, and cx/cy (magnification ratios), 
    // so cx and cy were declared "global" to function MakeImgAndZoom.
    function moveLens(e) {
        /*prevent any other actions that may occur when moving over the image:*/
        e.preventDefault();

        // Since getCursorPos was only called by moveLens, made this a private fn 
        // within moveLens.
    ...
    // The only things left in this function are things having to do with sizing 
