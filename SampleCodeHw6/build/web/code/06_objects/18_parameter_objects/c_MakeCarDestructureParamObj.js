// The call could be like this (below, same as parameter object)
// var dCarDiv = MakeCarDestructureParamObj({condition: "poor", price: 7500});
 
// The difference is in the function. You do not have to declare condition, price 
// (these are already declared in the function header). 
// And you dont have to test for missing properties and set default values 
// (this was already done in the function header). 

function MakeCarDestructureParamObj( { condition="unknown condition", price="Call for Price" } ) {
    
// This is the code that you do not have to do:
